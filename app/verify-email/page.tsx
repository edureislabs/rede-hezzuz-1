...
export default function VerifyEmailPage() {
  ...
  // Preenche automaticamente se veio da URL
  useEffect(() => {
    if (emailFromUrl) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-red-900 to-orange-900 px-4">
      ...
      >
        ...
        {/* EMAIL (pré-preenchido se veio do registro) */}
        <input
          type="email"
          placeholder="Seu email"
          value={email}
          onChange={(e) => setEmail(e.target.value)}
          className="w-full p-3 rounded-lg bg-black/60
        ...
        <input
          ...
          className="w-full p-3 rounded-lg bg-black/60
                     border border-gray-700 tracking-widest text-center text-lg
                     focus:outline-none focus:ring-2 focus:ring-orange-500
                     transition"
          required
        />
